package com.example.rahul.mibanddrinkwater.widgets;
...
import com.example.rahul.mibanddrinkwater.util.DensityUtil;
 ...
 */
public class DrinkLevelView extends View {
    ...
    private String mode = MODE_RECT; //default shape is circle
    ...
    private float speed = SPEED_SLOW;// default speed
    ...
    public DrinkLevelView(Context context) {
        super(context);
        init(context,null);
    }

    public DrinkLevelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs);
    }
